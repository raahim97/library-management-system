...
ResultSet rs;
    ...
    public boolean SearchIssue(){
        ...
        try{
            ...
            if(rs.next()){
                ...
                JOptionPane.showMessageDialog(null, "Can not return the book");
                return false;
            }
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 204)), "Return Book", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 24), new java.awt.Color(255, 153, 255))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        if(SearchIssue()!=false){
      String sql="insert into Return(BookID, ISBN, BName, Edition, Author, Price, Pages, StudentID, StudentName, FatherName, Institute, Branch, Course, Year, Semester, DateOfIssue, DueDate, ReturnDate, Fine)values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";  
